...
上述文档是关于贡献 D2 核心的。然而，D2 社区经常请求核心团队没有时间去做的事情（在 D2 达到 1.0 之前，我们正在积极优先处理能使 D2 对大多数用户更好的改进）。以下是可能需要你帮助的功能列表。如果你有兴趣主动承担，可以随时开始，也可以在 GitHub issue 中评论、在 Discord 中讨论，或发送电子邮件给我们（alex at terrastruct）。
...
想要在这个愿望清单上添加内容？只需在 D2 的 GitHub 上提交 Issue！
